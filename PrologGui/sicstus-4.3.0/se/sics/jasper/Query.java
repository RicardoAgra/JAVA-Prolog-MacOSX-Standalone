...
public interface Query
{
     ...
     * se.sics.jasper.Prolog#openPrologQuery openPrologQuery} was called. If
     ...
     * referred to by {@link se.sics.jasper.Term Term} objects),
     ...
     * queries opened after this query will be cut as well.
     <p>
     * A {@link se.sics.jasper.Query#close closed} or {@link
     * se.sics.jasper.Query#cut cut} query is invalidated and most
     * operations on it will throw an exception. In particular, you
     * should not call <code>close</code>, <code>cut</code> or
     * <code>nextSolution</code> on an invalidated query.
     <p>
     ...
     * opened query.  Invalidates all <code>Term</code> objects
     ...
     * to by {@link se.sics.jasper.Term Term} objects), you need

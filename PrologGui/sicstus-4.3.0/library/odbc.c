...
#if SICSTUS_BETA_VERSION || SICSTUS_VERSION <= 40300 /* [PM] 4.3.0. Revisit these issues again, if needed */
#define FORCE_BUILD 1
#endif  /* SICSTUS_BETA_VERSION */
#endif /* !defined FORCE_BUILD */

#if !defined FORCE_BUILD_ODBC
#if SICSTUS_VERSION == 40202 /* [PM] 4.2.2 these must be fixed before the next full release */
#define FORCE_BUILD_ODBC 1
#endif /* SICSTUS_VERSION */
#endif /* !defined FORCE_BUILD_ODBC */
...
#if (ODBC_DEBUG || SICSTUS_DBG || !SICSTUS_RELEASE_BUILD) && !FORCE_BUILD
...
#if 0                              /* TargeTypeSize is not used after this point */
                  TargetTypeSize = len +1; /* +1 for NUL */
#endif                             /* 0 */
                }
...
#if !FORCE_BUILD && SICSTUS_VERSION > 40300 /* [PM] 4.3 postpone. */

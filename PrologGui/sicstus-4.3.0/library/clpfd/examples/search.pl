...
no_overlap_decide(1,r(X1,W1,_Y1,_H1),r(X2,_W2,_Y2,_H2)) :-
    	X1 + W1 #=< X2.
no_overlap_decide(2,r(X1,_W1,_Y1,_H1),r(X2,W2,_Y2,_H2)) :-
    	X2 + W2 #=< X1.
no_overlap_decide(3,r(_X1,_W1,Y1,H1),r(_X2,_W2,Y2,_H2)) :-
    	Y1 + H1 #=< Y2.
no_overlap_decide(4,r(_X1,_W1,Y1,_H1),r(_X2,_W2,Y2,H2)) :-
    	Y2 + H2 #=< Y1.

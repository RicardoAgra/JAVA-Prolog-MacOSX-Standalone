...
fdbg_on(Options) :-
	...
	add_breakpoint([goal(clpfd:dispatch_global_fast(Constraint,_,_,Actions,_)),
			advice, port(exit)]-
...
pretty_bool(0o0, X, Y, Z, (X #/\ Y #<=> Z)).
pretty_bool(0o1, X, Y, Z, (X #/\ #\Y #<=> Z)).
pretty_bool(0o2, X, Y, Z, (#\X #\/ #\Y #<=> Z)).
pretty_bool(0o3, X, Y, Z, (X #\/ Y #<=> Z)).
pretty_bool(0o4, X, Y, Z, (X #\/ #\Y #<=> Z)).
pretty_bool(0o5, X, Y, Z, (#\X #/\ #\Y #<=> Z)).
pretty_bool(0o6, X, Y, Z, (X #<=> #\Y #<=> Z)).
pretty_bool(0o7, X, Y, Z, ((X #<=> Y) #<=> Z)).
pretty_bool(0o10, X, Y, _, (X #/\ Y)).
pretty_bool(0o11, X, Y, _, (X #/\ #\Y)).
pretty_bool(0o12, X, Y, _, (#\X #\/ #\Y)).
pretty_bool(0o13, X, Y, _, (X #\/ Y)).
pretty_bool(0o14, X, Y, _, (X #\/ #\Y)).
pretty_bool(0o15, X, Y, _, (#\X #/\ #\Y)).
pretty_bool(0o16, X, Y, _, (X #<=> #\Y)).
pretty_bool(0o17, X, Y, _, (X #<=> Y)).
pretty_bool(0o20, X, Y, _, (#\X #\/ #\Y)).
pretty_bool(0o21, X, Y, _, (#\X #\/ Y)).
pretty_bool(0o22, X, Y, _, (X #/\ Y)).
pretty_bool(0o23, X, Y, _, (#\X #/\ #\Y)).
pretty_bool(0o24, X, Y, _, (#\X #/\ Y)).
pretty_bool(0o25, X, Y, _, (X #\/ Y)).
pretty_bool(0o26, X, Y, _, (X #<=> Y)).
pretty_bool(0o27, X, Y, _, (X #<=> #\Y)).
...
user:portray_message(informational,
	...
	member(Pred, [clpfd:dispatch_global_fast/5,
